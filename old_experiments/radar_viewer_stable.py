...
from old_experiments.robot_nav_stable import build_robot_nav_state
from old_experiments.robot_nav_stable import CommandVoteSmoother
from old_experiments.robot_nav_stable import DEFAULT_ROBOT_NAV_CONFIG
from old_experiments.robot_nav_stable import merge_decision_config
from old_experiments.robot_nav_stable import RobotRadarNavigator
...
class DemoRadarSource:
    def __init__(self, nav_config=None, decision_config=None):
        ...
        self.command_smoother = CommandVoteSmoother(window_size=9)
        self.frame_number = 0
